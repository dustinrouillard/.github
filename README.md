...
I'm the CTO and Systems Administrator at [**Notify**](https://notify.me), but in my spare time I write a lot of code for personal projects such as the api that updates the table below, and I also do things for [**Hiven**](https://hiven.io) when I'm needed.
...
| :------------------------------------------ | ----------: | ----------: | -----------: |
| :hourglass_flowing_sand: Hours Spent Coding | **0.90hrs** | **7.74hrs** | **13.86hrs** |
| :computer: Commands                         |     **124** |     **784** |    **1,160** |
| :hammer: Docker Builds                      |       **0** |       **0** |        **0** |
